...
import { RSquareSoftLogo } from "../assets";
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen max-w-[1519px] mx-auto flex items-center justify-center bg-[#E0F2FF]">
        ...
        <div className="w-full md:w-1/2 p-8 pt-16">
          ...
          <div className="mb-4">
            ...
            <button
              ...
              className="mt-4 w-full bg-[#158CD0] text-white font-bold py-2 px-4 rounded-full hover:bg-blue-700"
            >
              Get OTP
            </button>
          </div>
