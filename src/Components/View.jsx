        ...
        <div>
            ...
            <div className="max-w-[1519px] h-fit mx-auto bg-[#E0F2FF]"> 
                <div className="bg-white h-fit  mx-auto max-w-6xl">
                    ...
                    {/* Customer Data Head */}
                    <div className="px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 mt-14 py-12 mx-auto">
                        <div className="bg-white p-4 rounded-lg shadow-md mx-auto max-w-6xl">
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                                <div className='flex-grow'>
                                    <h1 className='font-serif font-bold text-[30px]'>{customer.companyName}</h1>
                                    <p className='font-semibold'>Id : {data.id}</p>
                                    <p className='font-semibold'>Contact No : {data.contactNumber}</p>
                                    <p className='font-semibold'>GST No :  {data.gstNumber}</p>
                                    <p className='font-semibold'>{data.firstLineAddress}, {data.secondLineAddress}, {data.city}, {data.taluka}, {data.district}, {data.state}, {data.countryPinCode}</p>
                                </div>
                                <div className="flex flex-col md:flex-row items-start md:items-center mt-4 md:mt-0">
                                    <div className="text-right md:text-left mr-0 md:mr-4">
                                        <p className={`font-semibold text-xl ${data.status === 'Active' ? 'text-green-700' : 'text-red-700'}`}>{data.status}</p>
                                        <p className='font-semibold font-serif'><span className='italic font-serif'>Type</span> : {data.typeOfCompany}</p>
                    ...
                    <div className="p-4 max-w-4xl mx-auto">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="bg-white p-4 shadow rounded">
                                ...
                                <p>
                                    <ul>
                                        <li>{data.primaryContactFirstName} {data.primaryContactLastName}</li>
                            ...
                            <div className="bg-white p-4 shadow rounded">
                                ...
                                <p>
                                    <ul>
                                        <li>{data.secondaryContactFirstName} {data.secondaryContactLastName}</li>
                            ...
                            <div className="bg-white p-4 shadow rounded">
                                <h3 className="font-bold">Total Number of Cars Permitted per Day</h3>
                            ...
                            <div className="bg-white p-4 shadow rounded">
                                <h3 className="font-bold">Number of Drivers Allowed per Branch</h3>
                            ...
                            <div className="bg-white p-4 shadow rounded">
                                <h3 className="font-bold">Primary Contact and Company Manager Same?</h3>
                                <p>{data.primaryContactAndCompanyManagerSame === "Y" ? "Yes" : "No"}</p>
                            </div>
                        </div>
                    </div>
